...
CFLAGS = -Wall -Wextra -pedantic -m32 -O0 -std=c99 -finline-functions -fno-stack-protector -nostdinc -ffreestanding -fno-pic -fno-pie -fno-stack-protector  -Wno-unused-function -Wno-unused-parameter -g
...
run: naznaos-kernel naznaos-initrd
	${EMU} -kernel naznaos-kernel -initrd naznaos-initrd -append vid=qemu -serial stdio -vga std -s
...
#   Ram disk   #
################
naznaos-initrd: initrd/boot/kernel initrd/boot/stage2 initrd/bs.bmp
