...
CC = clang
GCC = gcc
CFLAGS = -Wall -Wextra -pedantic -m32 -O0 -std=c99 -finline-functions -fno-stack-protector -nostdinc -ffreestanding -fno-pic -fno-pie -fno-stack-protector  -Wno-unused-function -Wno-unused-parameter
LD = ld -m elf_i386
YASM = yasm
ECHO = `which echo` -e
...
#   Ram disk   #
################
naznaos-initrd: initrd bootloader/stage1.bin bootloader/stage2.bin initrd/stage3 initrd/kernel
	...
	@${DD} if=bootloader/stage2.bin of=naznaos-initrd seek=1 count=1 bs=512 2>/dev/null
